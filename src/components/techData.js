...
const techData = [
  {
    icon: <img src="https://videosdirectory.s3.us-east-2.amazonaws.com/images/PythonLogo.png" className="python-icon" />,
    label: "PYTHON",
    path: "/Portfolio",
  },
  {
  ...
  {
    icon: <img src="https://videosdirectory.s3.us-east-2.amazonaws.com/images/DartLogo.png" alt="Dart" className="Dart-icon"/>,
    label: "DART",
    path: "/Portfolio",
  },
  {
